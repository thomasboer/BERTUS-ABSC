# Hyperparameter tuning for BERTUS using Tree Parzen Estimator (TPE).
#
# BERTUS
#
# Adapted from DIWS
...
def run_hyper(domain, year, size, runs, n_iter):
    ...
    path = "hyper_results/BERTUS_model/" + domain + "/" + str(n_iter) + "/"
...
def bertus_objective(hyperparams, test_size, path):
    """
    ...
    l = BERTUS_hyper.main(FLAGS.hyper_train_path, FLAGS.hyper_train_path_target, FLAGS.hyper_eval_path,
